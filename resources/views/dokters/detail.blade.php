...
<div class="py-4 px-3 px-md-4">
    ...
    <div class="card mb-3 mb-md-4">
        <div class="card-body">
            ...
            <div class="mb-3 mb-md-4 d-flex justify-content-between">
                <div class="h3 mb-0">{{ $dokter->nama }}</div>
            </div>


            <div class="row">
                <div class="col-12 col-md-4">
                    <img src="{{ asset('storage/' . $dokter->image) }}" class="img-fluid">
                </div>
                <div class="col-12 col-md-8">
                    <dl class="row">
                        <dt class="col-sm-3">Nama Dokter</dt>
                        <dd class="col-sm-9">{{ $dokter->nama }}</dd>

                        <dt class="col-sm-3">Specialist</dt>
                        <dd class="col-sm-9">{{ $dokter->specialist }}</dd>

                        <dt class="col-sm-3">Jadwal</dt>
                        <dd class="col-sm-9">{{ $dokter->jadwal }}</dd>
                      </dl>
                </div>
            </div>
        </div>
