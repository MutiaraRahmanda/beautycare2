                ...
                <form action="{{ route('dokters.update', $dokter->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-12 col-md-6">
                            ...
                            <input type="text" class="form-control" id="specialist" name="specialist" value="{{ $dokter->specialist }}">
                        </div>

                        <div class="form-group col-12 col-md-6">
                            <label for="image">Foto</label>
                            <input type="file" class="form-control" id="image" name="image" value="{{ $dokter->image }}">
                        </div>
